export const my_blogs = {
  ...
  blog_2: {
    ...
    date: "2021-03-01",
    content:
      "Stackup has been there for me for quite some time now, from learning different types of web3 stuff to even web2 topics like ai/ml and other cool tech. Best thing about it is that we can earn money while doing so. It is one of the best motivator for me.",
  },
};
